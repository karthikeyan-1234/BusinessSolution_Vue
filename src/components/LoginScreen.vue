                                    ...
                                    <v-card-text class="mt-12">
                                        ...
                                        <v-row align="center" justify="center">
                                            <v-col cols="12" sm="8">
                                                ...
                                                <v-text-field v-model="userName" label="UserName" outlined dense color="blue" autocomplete="false"
                                                    class="mt-16" />
                                                ...
                                                <v-row>
                                                    ...
                                                    <v-col cols="12" sm="5">
                                                        <span class="caption blue--text"><a href="#">Forgot password</a></span>
                                                    </v-col>
                                                </v-row>
...
export default {
    ...
    methods:{
        async login(){
            ...
            await loginService.Login(this.loginModel).then((res:any) => {
                if(res != null)
                {
                    console.log(res);
                    localStorage.setItem("jwtToken",res.jwtToken.token);
